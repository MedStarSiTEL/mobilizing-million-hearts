                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <Slider
                        ...
                        onValueChange={(value) => setFormData({...formData, calcification: value[0]})}
                        max={2000}
                        min={0}
                        step={10}
                        className="w-full"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => setFormData({...formData, totalCholesterol: value[0], totalCholesterolMmol: Math.round((value[0] / 38.67) * 10) / 10})}
                          max={400}
                          min={100}
                          step={5}
                          className="w-full"
                      ...
                      <div className="space-y-3">
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => setFormData({...formData, totalCholesterolMmol: value[0], totalCholesterol: Math.round(value[0] * 38.67)})}
                          max={10.3}
                          min={2.6}
                          step={0.1}
                          className="w-full"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => setFormData({...formData, hdlCholesterol: value[0], hdlCholesterolMmol: Math.round((value[0] / 38.67) * 10) / 10})}
                          max={100}
                          min={20}
                          step={2}
                          className="w-full"
                      ...
                      <div className="space-y-3">
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => setFormData({...formData, hdlCholesterolMmol: value[0], hdlCholesterol: Math.round(value[0] * 38.67)})}
                          max={2.6}
                          min={0.5}
                          step={0.1}
                          className="w-full"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => setFormData({...formData, systolicBP: value[0], systolicBPKpa: Math.round((value[0] * 0.133) * 10) / 10})}
                          max={200}
                          min={90}
                          step={2}
                          className="w-full"
                      ...
                      <div className="space-y-3">
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => setFormData({...formData, systolicBPKpa: value[0], systolicBP: Math.round(value[0] / 0.133)})}
                          max={26.7}
                          min={12.0}
                          step={0.3}
                          className="w-full"
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioGroup 
                      ...
                      onValueChange={(value) => setFormData({...formData, lipidMedication: value})}
                      className="flex gap-8"
                    >
                      <div className="flex items-center space-x-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioGroup 
                      ...
                      onValueChange={(value) => setFormData({...formData, hypertensionMedication: value})}
                      className="flex gap-8"
                    >
                      <div className="flex items-center space-x-2">
